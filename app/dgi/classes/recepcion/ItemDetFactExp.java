...
@XmlType(name = "Item_Det_Fact_Exp", namespace = "http://cfe.dgi.gub.uy", propOrder = {
    "nroLinDet",
    "codItems",
    "indFact",
    "nomItem",
...
public class ItemDetFactExp {
    ...
    protected List<ItemDetFactExp.CodItem> codItems;
    ...
    protected List<ItemDetFactExp.SubDescuento> subDescuentos;
    ...
    protected List<ItemDetFactExp.SubRecargo> subRecargos;
     ...
     * 
     */
    public List<ItemDetFactExp.CodItem> getCodItems() {
        if (codItems == null) {
            codItems = new ArrayList<ItemDetFactExp.CodItem>();
        }
     ...
     * 
     */
    public List<ItemDetFactExp.SubDescuento> getSubDescuentos() {
        if (subDescuentos == null) {
            subDescuentos = new ArrayList<ItemDetFactExp.SubDescuento>();
        }
     ...
     * 
     */
    public List<ItemDetFactExp.SubRecargo> getSubRecargos() {
        if (subRecargos == null) {
            subRecargos = new ArrayList<ItemDetFactExp.SubRecargo>();
        }
