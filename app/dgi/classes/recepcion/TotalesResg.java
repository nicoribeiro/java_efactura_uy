...
@XmlType(name = "Totales_Resg", namespace = "http://cfe.dgi.gub.uy", propOrder = {
    "tpoMoneda",
    "tpoCambio",
    "mntTotRetenido",
    "mntTotCredFisc",
...
public class TotalesResg {
    ...
    public static class RetencPercep {
        ...
        @XmlElement(name = "CodRet", namespace = "http://cfe.dgi.gub.uy", required = true)
        protected String codRet;
        @XmlElement(name = "ValRetPerc", namespace = "http://cfe.dgi.gub.uy", required = true)
