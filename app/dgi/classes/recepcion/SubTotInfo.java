...
@XmlType(name = "SubTotInfo", namespace = "http://cfe.dgi.gub.uy", propOrder = {
    "stiItems"
})
public class SubTotInfo {
    ...
    public static class STIItem {
        ...
        @XmlElement(name = "NroSTI", namespace = "http://cfe.dgi.gub.uy")
        protected int nroSTI;
        @XmlElement(name = "GlosaSTI", namespace = "http://cfe.dgi.gub.uy", required = true)
        protected String glosaSTI;
        @XmlElement(name = "OrdenSTI", namespace = "http://cfe.dgi.gub.uy")
        protected Integer ordenSTI;
        @XmlElement(name = "ValSubtotSTI", namespace = "http://cfe.dgi.gub.uy", required = true)
