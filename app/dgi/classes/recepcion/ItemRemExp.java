...
@XmlType(name = "Item_Rem_Exp", namespace = "http://cfe.dgi.gub.uy", propOrder = {
    "nroLinDet",
    "codItems",
    "indFact",
    "nomItem",
...
public class ItemRemExp {
    ...
    protected List<ItemRemExp.CodItem> codItems;
     ...
     * 
     */
    public List<ItemRemExp.CodItem> getCodItems() {
        if (codItems == null) {
            codItems = new ArrayList<ItemRemExp.CodItem>();
        }
