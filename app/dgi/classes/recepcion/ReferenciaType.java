...
public class ReferenciaType {
    ...
    protected List<ReferenciaType.Referencia> referencia;
     ...
     * {@link ReferenciaType.Referencia }
     * 
     * 
     */
    public List<ReferenciaType.Referencia> getReferencia() {
        if (referencia == null) {
            referencia = new ArrayList<ReferenciaType.Referencia>();
        }
