...
@XmlRootElement(name = "EnvioCFE", namespace = "http://cfe.dgi.gub.uy")
public class EnvioCFE {

    @XmlElement(name = "Caratula", namespace = "http://cfe.dgi.gub.uy", required = true)
    protected EnvioCFE.Caratula caratula;
    @XmlElement(name = "CFE", namespace = "http://cfe.dgi.gub.uy", required = true)
    protected List<CFEDefType> cves;
     ...
     * This is why there is not a <CODE>set</CODE> method for the cves property.
     * 
     * <p>
     ...
     * 
     */
    public List<CFEDefType> getCVES() {
        if (cves == null) {
            cves = new ArrayList<CFEDefType>();
        }
        return this.cves;
    }
    ...
    public static class Caratula {
        ...
        @XmlElement(name = "RutReceptor", namespace = "http://cfe.dgi.gub.uy", required = true)
        ...
        @XmlElement(name = "CantCFE", namespace = "http://cfe.dgi.gub.uy")
        protected int cantCFE;
        @XmlElement(name = "Fecha", namespace = "http://cfe.dgi.gub.uy", required = true)
        protected XMLGregorianCalendar fecha;
        @XmlElement(name = "X509Certificate", namespace = "http://cfe.dgi.gub.uy", required = true)
