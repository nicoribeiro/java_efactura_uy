...
@XmlType(name = "MediosPago", namespace = "http://cfe.dgi.gub.uy", propOrder = {
    "medioPagos"
})
public class MediosPago {
    ...
    public static class MedioPago {
        ...
        @XmlElement(name = "NroLinMP", namespace = "http://cfe.dgi.gub.uy")
        protected int nroLinMP;
        @XmlElement(name = "CodMP", namespace = "http://cfe.dgi.gub.uy")
        protected BigInteger codMP;
        @XmlElement(name = "GlosaMP", namespace = "http://cfe.dgi.gub.uy", required = true)
        protected String glosaMP;
        @XmlElement(name = "OrdenMP", namespace = "http://cfe.dgi.gub.uy")
        protected BigInteger ordenMP;
        @XmlElement(name = "ValorPago", namespace = "http://cfe.dgi.gub.uy", required = true)
