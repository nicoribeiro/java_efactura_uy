...
public class SignedInfo {
    ...
    protected List<DsigReferenceType> references;
     ...
     * {@link DsigReferenceType }
     * 
     * 
     */
    public List<DsigReferenceType> getReferences() {
        if (references == null) {
            references = new ArrayList<DsigReferenceType>();
        }
