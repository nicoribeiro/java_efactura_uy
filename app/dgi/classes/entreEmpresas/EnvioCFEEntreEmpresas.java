...
public class EnvioCFEEntreEmpresas {
    ...
    protected List<CFEEmpresasType> cfeAdendas;
    ...
    /**
     * Gets the value of the cfeAdendas property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the cfeAdendas property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCFEAdendas().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CFEEmpresasType> getCFEAdendas() {
        if (cfeAdendas == null) {
            cfeAdendas = new ArrayList<CFEEmpresasType>();
        }
        return this.cfeAdendas;
    }
